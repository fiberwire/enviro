...
import { IEnvironment, IEnvironmentOptions, IStateUpdate, ReactiveProperty } from '../index';

import { Observable, Subscription } from "rxjs/Rx";

export abstract class DirectEnvironment<EState> implements IEnvironment<EState> {
